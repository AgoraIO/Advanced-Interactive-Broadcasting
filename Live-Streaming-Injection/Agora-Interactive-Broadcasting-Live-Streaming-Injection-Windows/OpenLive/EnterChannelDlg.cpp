...
void CEnterChannelDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_EDIT_INJECTED_URL, m_ctrInJectedUrl);
}
...
void CEnterChannelDlg::OnBnClickedBtnjoinChannel()
{
	...
	m_ctrInJectedUrl.GetWindowText(strInjectedUrl);
...
CString CEnterChannelDlg::getInjectedUrl()
{
	CString strInjectedUrl;	

	m_ctrInJectedUrl.GetWindowTextW(strInjectedUrl);

	return strInjectedUrl;
}
