...
typedef struct _AGE_STREAM_INJIECTED_STATUS
{
	char url[MAX_PATH];
	int uid;
	int status;
}AGE_STREAM_INJECTED_STATUS, *PAGE_STREAM_INJECTED_STATUS, *LPAGE_STREAM_INJECTED_STATUS;

#define EID_STREAM_INJECTED_STATUS 0x00000021
