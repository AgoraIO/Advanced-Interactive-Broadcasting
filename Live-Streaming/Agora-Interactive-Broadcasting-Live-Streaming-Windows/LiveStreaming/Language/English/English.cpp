...
ENGLISH_API LPCTSTR IDS_PUB_STRINGTIP = _T("rtmp_url");
ENGLISH_API LPCTSTR IDS_PUB_WIDTHTIP = _T("width");
ENGLISH_API LPCTSTR IDS_PUB_HEIGHTTIP = _T("height");
ENGLISH_API LPCTSTR IDS_PUB_FRAMERATETIP = _T("framerate");
ENGLISH_API LPCTSTR IDS_PUB_BITRATETIP = _T("bitrate");

ENGLISH_API LPCTSTR IDS_PUB_AUDSAMPRATETIP = _T("AudioSampleRate");
ENGLISH_API LPCTSTR IDS_PUB_AUDBITERATETIP = _T("AudioBitrate");
ENGLISH_API LPCTSTR IDS_PUB_AUDCHANNELTIP = _T("AudioChannel");

ENGLISH_API LPCTSTR IDS_PUB_BINDTOCHANNEL = _T("bind to channel");
ENGLISH_API LPCTSTR IDS_PUB_BINDTOOWNER = _T("bind to owner");

ENGLISH_API LPCTSTR IDS_EXTSET_WIDTH = _T("Width");
ENGLISH_API LPCTSTR IDS_EXTSET_HEIGHT = _T("Height");
ENGLISH_API LPCTSTR IDS_EXTSET_FPS = _T("FPS");
ENGLISH_API LPCTSTR IDS_EXTSET_BITRATE = _T("Bitrate");
ENGLISH_API LPCTSTR IDS_EXTSET_GOP = _T("GOP");
